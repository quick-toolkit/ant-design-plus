...
function PlusProvider(props) {
    const { children, antProviderProps = {} } = props, value = __rest(props, ["children", "antProviderProps"]);
    value.antLocale = value.antLocale || (antProviderProps === null || antProviderProps === void 0 ? void 0 : antProviderProps.locale);
    return (0, react_1.createElement)(exports.PlusContext.Provider, {
        value,
        children: (0, react_1.createElement)(antd_1.ConfigProvider, Object.assign(Object.assign({ locale: props.antLocale }, antProviderProps), { children })),
    });
}
